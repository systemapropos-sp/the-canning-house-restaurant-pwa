...
const menuCategories: MenuCategory[] = [
  {
    ...
    items: [
      { name: 'Crabby Cheese Fries', price: '17', description: 'Fries tossed in old bay topped with house beer cheese & jumbo lump crab', image: '/images/starters.jpg' },
      ...
      { name: 'Thai Chili Mozz Moons', price: '12', description: 'Three breaded mozzarella moons tossed in house thai chili sauce', image: '/images/starters.jpg' },
      { name: 'Black Truffle Mac & Cheese', price: '15', description: 'House beer mac & cheese topped with parmesan, parsley, tartufi truffle oil & truffle shavings', image: '/images/starters.jpg', badge: 'Popular' },
      { name: 'Brulee PBJ', price: '14', description: 'Toasted ciabatta with peanut butter, house berry jam, bruleed banana & nut crumble', image: '/images/starters.jpg' },
      { name: 'Catsmo Smoked Salmon Avocado Toast', price: '23', description: 'Toasted ciabatta with catsmo smoked salmon, smashed avocado, cucumber, red onion, alfalfa sprouts & lemon zest', image: '/images/starters.jpg', badge: 'Chef Pick' },
      { name: 'Sunrise Avocado Toast', price: '14', description: 'Toasted ciabatta with smashed avocado, toasted sunflower seeds, shichimi togarashi, alfalfa sprouts & lemon zest', image: '/images/starters.jpg', badge: 'Veggie' },
      ...
      { name: 'Fried Mac Balls', price: '12', description: 'House beer mac n cheese, balled and fried, served with tomato soup', image: '/images/starters.jpg' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Cajun Shrimp & Crab Breakfast Bowl', price: '28', description: 'Home fries with scrambled eggs, cajun shrimp, lump & claw crab & beer cheese', image: '/images/brunch.jpg', badge: 'Premium' },
      { name: 'Canning Griddle Sando', price: '13', description: 'Cage-free eggs, cooper sharp cheese, hot honey & bacon on house brioche french toast', image: '/images/brunch.jpg', badge: 'Popular' },
      { name: 'Fresh Berry Brunch', price: '17', description: 'House made waffle or french toast topped with fresh blueberries, raspberries, strawberries & blackberries with house whipped cream', image: '/images/brunch.jpg' },
      { name: 'Bananas Foster', price: '17', description: 'House made waffle or french toast with fresh bananas, banana nut crumble & caramel sauce', image: '/images/brunch.jpg' },
      { name: 'Fried Chicken & Waffles', price: '20', description: 'Buttermilk dredged fried chicken atop a house-made waffle with hot honey butter', image: '/images/brunch.jpg', badge: 'Best Seller' },
      { name: 'French Toast or Pearl Waffle Fried Chicken Sando', price: '15', description: 'Southern style fried chicken with maple syrup & bacon on brioche french toast or pearl sugar waffles', image: '/images/brunch.jpg' },
      ...
      { name: 'Breakfast Bagel Sando', price: '12', description: 'Cage-free eggs, cooper sharp cheese, sriracha aioli, smashed avocado & bacon or sausage on everything bagel', image: '/images/brunch.jpg' },
      ...
      { name: 'Brunch Burger', price: '19', description: '8oz prime cut burger, cage-free fried egg, coopers sharp, sriracha aioli, applewood bacon or house sausage on brioche roll', image: '/images/brunch.jpg' },
    ],
  },
  {
    id: 'salads',
    ...
    items: [
      { name: 'Tahini Caesar Salmon', price: '24', description: 'Little gem lettuce, multicolor cherry tomatoes, cucumbers, garlic breadcrumbs, grilled atlantic salmon, house tahini caesar', image: '/images/salads.jpg', badge: 'Popular' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Canning House Reuben', price: '17', description: 'Thirteen-hour IPA braised corn beef, sauerkraut, swiss cheese & russian dressing on rye', image: '/images/sandos.jpg', badge: 'Signature' },
      { name: 'Fried Chicken Sando', price: '14', description: 'Southern-style buttermilk chicken breast with lettuce, house-pickled onions & pickles, chipotle ranch on brioche', image: '/images/sandos.jpg' },
      { name: 'Hot Honey Fried Chicken Sando', price: '16', description: 'Buttermilk dredged fried chicken with sliced cheddar, lettuce, hot honey, garlic aioli & pickles', image: '/images/sandos.jpg', badge: 'Popular' },
      ...
      { name: 'Grilled Cheese', price: '13', description: 'Provolone, swiss, cheddar & cooper cheese melted on buttered sourdough with house tomato basil bisque', image: '/images/sandos.jpg' },
      { name: 'French Dip Grilled Cheese', price: '21', description: 'Braised CAB short rib, caramelized onions, provolone & mozzarella on buttered sourdough with au jus', image: '/images/sandos.jpg', badge: 'Premium' },
      { name: 'Crabby Grilled Cheese', price: '22', description: 'Sliced cooper & white cheddar, claw & jumbo lump crab with old bay on buttered sourdough', image: '/images/sandos.jpg', badge: 'Premium' },
      ...
      { name: 'Ham and Swiss Grilled Cheese', price: '17', description: 'Sliced black forest ham, caramelized onions, mustard & swiss on buttered sourdough', image: '/images/sandos.jpg' },
    ],
  },
  {
    id: 'sides',
    ...
    items: [
      ...
      { name: 'Black Truffle Parmesan Mac', price: '15', description: 'Our mac and cheese elevated with black truffle & parmesan', image: '/images/sides.jpg', badge: 'Premium' },
      ...
      { name: 'Mini Waffle', price: '7', description: 'Pearl sugar waffle with fresh berries', image: '/images/sides.jpg' },
      ...
      { name: 'Truffle Parmesan Fries', price: '8', description: 'Crispy fries with truffle oil & parmesan', image: '/images/sides.jpg' },
